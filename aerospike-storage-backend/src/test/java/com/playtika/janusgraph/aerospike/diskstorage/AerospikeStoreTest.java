...
public class AerospikeStoreTest extends KeyColumnValueStoreTest {
    ...
    public static final String DUE_TO_SCAN_KEYS_INCONSISTENCY
            = "Due to Aerospike scan operation inconsistency " +
            "StandardScannerExecutor become inconsistent in multi-thread mode";
...
//    @Tag(DUE_TO_SCAN_KEYS_INCONSISTENCY)
//    @Ignore
//    @Override
//    @Test
